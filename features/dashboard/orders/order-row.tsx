...
import { type Order, calculateOrderTotal, formatDate, formatPrice } from "@/utils/order-utils"
...
export default function OrderRow({ order, isExpanded, onToggleExpand }: OrderRowProps) {
    return (
        <React.Fragment>
            <TableRow className="cursor-pointer hover:bg-muted/50">
                ...
                <TableCell onClick={onToggleExpand}>{formatDate(order.created_at)}</TableCell>
